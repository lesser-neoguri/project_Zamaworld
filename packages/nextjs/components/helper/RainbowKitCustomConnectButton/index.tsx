        ...
        return (
          <>
            {(() => {
              if (!connected) {
                return (
                  <button className="btn btn-md rounded-none text-gray-900 cursor-pointer border-none" style={{ backgroundColor: 'var(--color-accent)' }} onClick={openConnectModal} type="button">
                    Connect Wallet
                  </button>
                );
              }
